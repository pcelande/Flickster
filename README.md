...
- J'ai du depouiller mon fichier "activity_movie.xml" avant d'avoir une application bien affichee en mode paysage ;
- J'ai du donner a mon paquet un nom different du walkthrough pour faire marcher mon app ;
